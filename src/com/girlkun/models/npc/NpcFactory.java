...
//                                 this.npcChat(player, "Chức năng đang bảo trì ");
    ...
    private static Npc ChampaDoiDe(int mapId, int status, int cx, int cy, int tempId, int avartar){
        return new Npc(mapId, status, cx, cy, tempId, avartar){
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7| BẠN LÀ NGƯỜI CÓ TIỀN VÀ LƯỜI CÀY"
                                    ...
                                    "\n|-1|- ĐỆ SQUID GAME: 130K(100% CS KHI HOP THE PORATA C2)" +
                                     "\n|-1|- ĐỆ QUY LÃO: 130K(100% CS KHI HOP THE PORATA C2)" +
                                    "\n|-1|- ĐỆ Đường Tăng: 130K(100% CS KHI HOP THE PORATA C2)" +
                                    "\n|-1|- ĐỆ ANDROID 18: 130K(100% CS KHI HOP THE PORATA C2)" +
                                    "\n\n|7| SỐ TIỀN BẠN ĐANG CÓ: " + Util.format(player.getSession().vnd),
                            "Đệ Vegeta", "Đệ Picolo", "Đệ Anime","Đệ Gái xinh", "Đệ Vegeta Giáo sư", "Đệ Squid Game", "Đệ Quy lão", "Đệ Đường tăng"
                                    , "Đệ Số 18", "Tù chối");
                }
            }
                        ...
                        switch (select) {
                                ...
                                if(player.getSession().vnd < 40000){
                                    ...
                                    if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                        if(player.pet != null){
                                            ...
                                            PetService.gI().ChangePet(player, gender, 6);
                            ...
                            case 1:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 4);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                            ...
                            case 2:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 5);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                            ...
                            case 3:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 7);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                            ...
                            case 6:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 10);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                                        PlayerDAO.subvnd(player, 130000);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Không thể thực hiện");
                            ...
                            case 7:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 11);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                                        PlayerDAO.subvnd(player, 130000);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Không thể thực hiện");
                            ...
                            case 8:
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBody(player.pet) == 8){
                                    if(player.pet != null){
                                        int gender = player.pet.gender;
                                        PetService.gI().ChangePet(player, gender, 12);
                                        this.npcChat(player, "Chúc mừng đã đổi đệ");
                                        PlayerDAO.subvnd(player, 130000);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Không thể thực hiện");
...
//                    }
    ...
    public static Npc NPCHockAdmin(int mapId, int status, int cx, int cy, int tempId, int avartar){
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    try {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|CHỨC NĂNG BUFF BẨN CỦA DÂN CÀY"
                                + "\n|-1|1. NEXT BA NHIỆM VỤ (10 cành)"
                                + "\n|-1|2. NEXT FULL NHIỆM VỤ (50 cành)"
                                + "\n|-1|3. ",
                                "Option 1", "Option 2", "Option 3", "Từ chối"
                        );
                    } catch (Exception e) {
                    }
                }
            ...
            public void confirmMenu(Player player, int select) {
                 if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch(select){
                            case 1:
                                Input.gI().createFormNextTask(player);
                                break; 
                        }
                    }
                 }
    ...
    public static Npc SieuMap(int mapId, int status, int cx, int cy, int tempId, int avartar){
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    try {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|MAP UP VẬT PHẨM VIP"
                                + "\n|-1|1. MAP THIÊN THẦN"
                                + "\n|-1|2. MAP ĐỊA NGỤC"
                                + "\n|-1|3. MAP SIÊU NHIÊN",
                                "Option 1", "Option 2", "Option 3", "Từ chối"
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                case ConstNpc.NPC_SIEUMAP:
                    return SieuMap(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.CHAMPA:
                    return ChampaDoiDe(mapId, status, cx, cy, tempId, avatar);
...
//                    return meothantai(mapId, status, cx, cy, tempId, avatar);
                ...
                case ConstNpc.NPC_HOCK:
                    return NPCHockAdmin(mapId, status, cx, cy, tempId, avatar);
